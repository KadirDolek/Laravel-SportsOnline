...
class JoueurController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Joueur::with(['equipe', 'position', 'genre', 'user']); // Ajout de 'user'
    ...
    {
        $this->authorize('create-joueur'); // Uniquement le nouveau Gate
    ...
    {
        $this->authorize('manage-joueur', $joueur); // Uniquement le nouveau Gate
    ...
    {
        $this->authorize('manage-joueur', $joueur); // Correction de la méthode

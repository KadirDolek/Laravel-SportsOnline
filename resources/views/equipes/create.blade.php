...
<x-app-layout>
    ...
    <div class="relative">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 py-10">
            <h1 class="text-3xl md:text-4xl font-extrabold text-white drop-shadow">Créer une nouvelle équipe</h1>
            <p class="mt-2 text-gray-300">Renseigne les champs obligatoires (<span class="text-red-400">*</span>).</p>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-b from-black via-[#070b1f] to-[#050713] py-10">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div class="rounded-2xl border border-white/10 bg-white/5 backdrop-blur">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('equipes.store') }}" class="space-y-8">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select
                                    name="continent_id" id="continent_id" required
